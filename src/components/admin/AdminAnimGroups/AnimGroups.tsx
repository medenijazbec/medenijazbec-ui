          ...
          <div className={styles.card}>
            ...
            <div className={styles.row}>
              <input
                ...
                placeholder="Title (e.g., Breakdance Combo A)"
                value={title}
                ...
                <div className={styles.list}>
                  {clips.map(c => (
                    <div className={`${styles.item} ${c.checked ? styles.selected : ''}`} key={c.name}>
                      ...
                      <label onClick={() => setPreview(c.name)} title={c.name}>
                        {c.name}
                      </label>
                      {c.checked && (
                        <>
                          ...
                          <Button className={styles.btn} onClick={() => move(c.name, -1)} title="Move up">
                            ↑
                          </Button>
                          <Button className={styles.btn} onClick={() => move(c.name, +1)} title="Move down">
                            ↓
                          </Button>
                        </>
                      )}
