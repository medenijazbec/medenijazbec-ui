...
import styles from "./HardwareProj.module.css";
...
const HardwareProjects: React.FC = () => {
  ...
  useEffect(() => {
    projects.list({ kind: "hardware" }).then(setItems).catch(console.error);
  }, []);
  ...
  return (
    <section className={styles.wrap}>
      ...
      <div className={styles.grid}>
        ...
        {!items.length && <div className={styles.empty}>No hardware projects yet.</div>}
      </div>
